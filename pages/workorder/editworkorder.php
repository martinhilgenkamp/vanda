...
<form action="pages/workorder/processorder.php" method="POST" onsubmit="return validateForm();" id="workorderform" enctype="multipart/form-data">
    ...
    <input type="text" id="opdrachtnr" name="opdrachtnr" required maxlength="10" pattern="\d+" 
           value="<?php echo $isEditMode ? htmlspecialchars($existingWorkOrder->opdrachtnr ?? '', ENT_QUOTES, 'UTF-8') : ''; ?>">*<br><br>

    <label for="omschrijving">Omschrijving:</label><br>
    <textarea id="omschrijving" name="omschrijving" required minlength="10" maxlength="500"><?php echo $isEditMode ? htmlspecialchars($existingWorkOrder->omschrijving ?? '', ENT_QUOTES, 'UTF-8') : ''; ?></textarea><br><br>

    <label for="klant">Klant</label><br>
    <input type="text" id="klant" name="klant" required minlength="3" maxlength="100" 
           value="<?php echo $isEditMode ? htmlspecialchars($existingWorkOrder->klant ?? '', ENT_QUOTES, 'UTF-8') : ''; ?>">*<br><br>

    <label for="opdrachtnr_klant">Opdrachtnr Klant:</label><br>
    <input type="text" id="opdrachtnr_klant" name="opdrachtnr_klant" required 
           value="<?php echo $isEditMode ? htmlspecialchars($existingWorkOrder->opdrachtnr_klant ?? '', ENT_QUOTES, 'UTF-8') : ''; ?>">*<br><br>
    ...
    <input type="date" id="leverdatum" name="leverdatum" required 
           value="<?php echo $isEditMode ? htmlspecialchars($existingWorkOrder->leverdatum ?? '', ENT_QUOTES, 'UTF-8') : ''; ?>">*<br><br>

    <label for="start">Start Tijd</label><br>
    <input type="datetime-local" id="start" name="start" 
           value="<?php echo $isEditMode ? htmlspecialchars($existingWorkOrder->start ?? '', ENT_QUOTES, 'UTF-8') : ''; ?>"><br><br>

    <label for="start">Eind Tijd</label><br>
    <input type="datetime-local" id="end" name="end" 
           value="<?php echo $isEditMode ? htmlspecialchars($existingWorkOrder->end ?? '', ENT_QUOTES, 'UTF-8') : ''; ?>"><br><br>

    <label for="resource1">Resource 1</label><br>
    <input type="text" id="resource1" name="resource1" 
           value="<?php echo $isEditMode ? htmlspecialchars($existingWorkOrder->resource1 ?? '', ENT_QUOTES, 'UTF-8') : ''; ?>"><br><br>

    <label for="resource2">Resource 2</label><br>
    <input type="text" id="resource2" name="resource2" 
           value="<?php echo $isEditMode ? htmlspecialchars($existingWorkOrder->resource2 ?? '', ENT_QUOTES, 'UTF-8') : ''; ?>"><br><br>

    <label for="verpakinstructie">Verpakinstructie:</label><br>
    <textarea id="verpakinstructie" name="verpakinstructie"><?php echo $isEditMode ? htmlspecialchars($existingWorkOrder->verpakinstructie ?? '', ENT_QUOTES, 'UTF-8') : ''; ?></textarea><br><br>

    <label for="opmerkingen">Opmerkingen:</label><br>
    <textarea id="opmerkingen" name="opmerkingen"><?php echo $isEditMode ? htmlspecialchars($existingWorkOrder->opmerkingen ?? '', ENT_QUOTES, 'UTF-8') : ''; ?></textarea><br><br>
